const float a0 = 0.231076;
const float a1 = 0.000881119;
const float a2 = -0.000000037629;
...
int adcPins[NUM_NODES] = {25, 26, 27, 14, 12, 13};

void setup() {
  Serial.begin(115200);
  delay(3000);
  Serial.println("STARTING ADC2 MEASUREMENT...");
